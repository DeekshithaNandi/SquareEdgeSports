...
// //         if (!emailEnabled) {
// //             log.info("Admin invite token for {}: {}", to, token);
// //             return;
// //         }
...
// //         if (!emailEnabled) {
// //             log.info("Court assignment for {}: lane={} court={}", to, laneNumber, courtNumber);
// //             return;
// //         }
...
// //         String assignment;
// //         if (laneNumber != null)
// //             assignment = "Lane " + laneNumber + (boxGroup != null ? " (" + boxGroup.replace("_", " ") + ")" : "");
// //         else if (courtNumber != null)
// //             assignment = "Court " + courtNumber;
// //         else if (boxGroup != null)
// //             assignment = boxGroup.replace("_", " ");
// //         else
// //             assignment = "TBD";

// //         String html = header("Court Assigned ✅") +
// //                 "<h2 style='color:#eeeef8;font-size:20px;margin:0 0 8px;'>Hi " + name + " 👋</h2>" +
// //                 "<p style='color:#9090b0;font-size:14px;line-height:1.6;'>Your " + sport
// //                 + " booking has been assigned. See details below.</p>" +
// //                 "<div style='background:#1a1a2e;border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:24px;margin:20px 0;'>"
// //                 +
// //                 "<table style='width:100%;font-size:14px;'>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Sport</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
// //                 + sport + "</td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Date</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
// //                 + date + "</td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Time</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
// //                 + startTime + "</td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;border-top:1px solid rgba(255,255,255,.07);padding-top:12px;'>Assigned</td>"
// //                 +
// //                 "<td style='color:#7c5cfc;font-weight:800;font-size:18px;text-align:right;border-top:1px solid rgba(255,255,255,.07);padding-top:12px;'>"
// //                 + assignment + "</td></tr>" +
// //                 "</table></div>" +
...
// //         if (!emailEnabled) {
// //             log.info("Membership activation for {}: sport={}", to, sportType);
// //             return;
// //         }
// //         String sport = switch (sportType != null ? sportType : "") {
// //             case "CRICKET_LANE" -> "🏏 Cricket Lane";
...
// //                 "<h2 style='color:#eeeef8;font-size:20px;margin:0 0 8px;'>Hi " + name + " 👋</h2>" +
// //                 "<p style='color:#9090b0;font-size:14px;line-height:1.6;'>Your <strong style='color:#eeeef8'>" + sport
// //                 + "</strong> membership has been activated! Enjoy discounted session rates.</p>" +
// //                 "<div style='background:#1a1a2e;border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:24px;margin:20px 0;'>"
// //                 +
// //                 "<table style='width:100%;font-size:14px;'>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Sport</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
...
// //                 +
// //                 "<td style='color:#7c5cfc;font-weight:800;font-size:16px;text-align:right;border-top:1px solid rgba(255,255,255,.07);padding-top:12px;'>"
// //                 + expiresAt + "</td></tr>" +
// //                 "</table></div>" +
...
// //         if (!emailEnabled) {
// //             log.info("Refund confirmation for {}: policy={} amount={}", to, refundPolicy, refundAmount);
// //             return;
// //         }
// //         String sport = switch (sportType != null ? sportType : "") {
// //             case "CRICKET_LANE" -> "🏏 Cricket Lane";
...
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Date</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
// //                 + date + "</td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;'>Policy</td><td style='color:#eeeef8;font-weight:700;text-align:right;'>"
// //                 + policyLabel + "</td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:6px 0;border-top:1px solid rgba(255,255,255,.07);padding-top:12px;'>Refund Amount</td>"
// //                 +
// //                 "<td style='color:#22c55e;font-weight:800;font-size:20px;text-align:right;border-top:1px solid rgba(255,255,255,.07);padding-top:12px;'>"
// //                 + amountStr + "</td></tr>" +
// //                 "</table></div>" +
...
// //         if (!emailEnabled) {
// //             log.info("No-refund notification for {}: sport={} date={}", to, sportType, date);
// //             return;
// //         }
// //         String sport = switch (sportType != null ? sportType : "") {
// //             case "CRICKET_LANE" -> "🏏 Cricket Lane";
...
// //                 " session on <strong style='color:#eeeef8'>" + date + "</strong> at <strong style='color:#eeeef8'>"
// //                 + startTime + "</strong>.</p>" +
...
// //                 "<td style='padding:8px 0;'><a href='mailto:" + senderEmail
// //                 + "' style='color:#7c5cfc;font-weight:700;text-decoration:none;'>" + senderEmail + "</a></td></tr>" +
// //                 "<tr><td style='color:#6b6b8a;padding:8px 0;'>Subject</td>" +
// //                 "<td style='color:#eeeef8;font-weight:700;padding:8px 0;'>"
// //                 + (subject != null && !subject.isBlank() ? subject : "(no subject)") + "</td></tr>" +
// //                 "</table></div>" +
...
// //                 +
// //                 "<p style='color:#eeeef8;font-size:14px;line-height:1.7;margin:0;white-space:pre-wrap;'>" + message
// //                 + "</p></div>" +
// //                 "<p style='color:#6b6b8a;font-size:12px;'>Reply directly to this email to respond to " + senderName
// //                 + ".</p>" +
// //                 footer();
...
// //             helper.setSubject(
// //                     "📩 Contact: " + (subject != null && !subject.isBlank() ? subject : "Message from " + senderName));
...
// //                 "<a href='" + resetLink
// //                 + "' style='background:linear-gradient(135deg,#7c5cfc,#4f8ef7);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:14px;display:inline-block;'>Reset Password →</a></div>"
// //                 +
...
// //                 "<h2 style='color:#eeeef8;font-size:20px;margin:0 0 8px;'>Hi " + name + " 👋</h2>" +
// //                 "<p style='color:#9090b0;font-size:14px;line-height:1.6;'>You've been invited to join <strong style='color:#eeeef8'>SquareEdgeSports</strong> as <strong style='color:#7c5cfc;'>"
// //                 + role + "</strong>. Click below to set up your password and access your account.</p>" +
// //                 "<div style='text-align:center;margin:28px 0;'>" +
// //                 "<a href='" + setupLink
// //                 + "' style='background:linear-gradient(135deg,#22c55e,#16a34a);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:14px;display:inline-block;'>Set Up My Account →</a></div>"
// //                 +
...
// //                 "<p style='color:#9090b0;'>Your booking <strong style='color:#eeeef8'>#" + ref
// //                 + "</strong> has been confirmed.</p>" +
// //                 "<div style='background:#1a1a2e;border-radius:10px;padding:16px;margin:16px 0;color:#9090b0;font-size:13px;'>"
// //                 + details + "</div>" +
// //                 footer();
// //     }
...
//                 +
//                 "<table style='width:100%;font-size:14px;border-collapse:collapse;'>" +
//                 "<tr><td style='color:#6b6b8a;padding:8px 0;width:100px;'>Name</td><td style='color:#eeeef8;font-weight:700;padding:8px 0;'>"
//                 + senderName + "</td></tr>" +
//                 "<tr><td style='color:#6b6b8a;padding:8px 0;'>Email</td><td style='padding:8px 0;'><a href='mailto:"
//                 + senderEmail + "' style='color:#7c5cfc;font-weight:700;text-decoration:none;'>" + senderEmail
//                 + "</a></td></tr>" +
//                 "<tr><td style='color:#6b6b8a;padding:8px 0;'>Subject</td><td style='color:#eeeef8;font-weight:700;padding:8px 0;'>"
//                 + (subject != null && !subject.isBlank() ? subject : "(no subject)") + "</td></tr>" +
//                 "</table></div>" +
//                 "<div style='background:#12122a;border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:20px;margin:0 0 20px;'>"
//                 +
...
//                 + ".</p>" +
//                 footer();
//         sendHtml("onboarding@resend.dev",
//                 "📩 Contact: " + (subject != null && !subject.isBlank() ? subject : "Message from " + senderName),
//                 html);
//     }
...
//                     .from("SquareEdgeSports <onboarding@resend.dev>")
//                     .to(to)
//                     .subject(subject)
//                     .html(html)
//                     .build();
